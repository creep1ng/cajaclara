...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_categories_transaction_type"),
        "categories",
        ["transaction_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "enabled", sa.Boolean(), nullable=False, comment="Si la regla está activa"
        ),
        sa.Column(
            "times_applied",
            sa.Integer(),
    ...
    op.create_index(
        op.f("ix_category_rules_enabled"), "category_rules", ["enabled"], unique=False
    )
    op.create_index(
        op.f("ix_category_rules_user_id"), "category_rules", ["user_id"], unique=False
    )
    op.create_table(
        "entrepreneurships",
        sa.Column("user_id", sa.UUID(), nullable=False, comment="Usuario propietario"),
    ...
    op.create_index(
        op.f("ix_entrepreneurships_is_active"),
        "entrepreneurships",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_entrepreneurships_user_id"),
        "entrepreneurships",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "currency", sa.String(length=3), nullable=False, comment="Moneda (ISO 4217)"
        ),
        sa.Column(
            "description", sa.Text(), nullable=True, comment="Descripción o nota"
        ),
        sa.Column(
            "transaction_type",
            sa.String(length=20),
        ...
        sa.Column(
            "tags", sa.ARRAY(sa.Text()), nullable=True, comment="Etiquetas adicionales"
        ),
        sa.Column(
            "metadata",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.ForeignKeyConstraint(
            ["entrepreneurship_id"], ["entrepreneurships.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "idx_transactions_category", "transactions", ["category_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_transactions_entrepreneurship",
        "transactions",
        ["entrepreneurship_id"],
        unique=False,
    )
    op.create_index(
        "idx_transactions_metadata",
        "transactions",
        ["metadata"],
        unique=False,
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_transactions_metadata", table_name="transactions", postgresql_using="gin"
    )
    ...
    op.drop_index(
        op.f("ix_entrepreneurships_is_active"), table_name="entrepreneurships"
    )
