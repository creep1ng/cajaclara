...
class TransactionRepository(BaseRepository[Transaction]):
    ...
    async def list_with_filters(
        self, user_id: UUID, filters: TransactionFilters, skip: int = 0, limit: int = 20
        ...
        if filters.entrepreneurship_id:
            conditions.append(
                Transaction.entrepreneurship_id == filters.entrepreneurship_id
            )
    ...
    async def calculate_summary(
        self, user_id: UUID, filters: TransactionFilters
    ) -> TransactionSummary:
        """
        ...
        query = (
            ...
            .where(and_(*conditions))
            .group_by(Transaction.transaction_type, Transaction.classification)
        )
